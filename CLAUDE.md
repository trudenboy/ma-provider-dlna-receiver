...
This file aligns development of the **DLNA Receiver** provider with the
...
provider (someone editing `music_assistant/providers/dlna_receiver/` directly in
...
`music_assistant/providers/dlna_receiver` upstream eventually — that is the
