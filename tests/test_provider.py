...
from provider.lifecycle import deterministic_udn
from provider.metadata import position_for
from provider.models import RendererInstance
from provider.provider import DLNAReceiverProvider
...
def _make_instance(player_id: str, player_name: str, url: str | None = None) -> RendererInstance:
    ...
    from provider.ssdp import SSDPAdvertiser  # noqa: PLC0415
...
def test_is_concrete_ipv4_accepts_routable_addresses(value: str) -> None:
    ...
    from provider.provider import _is_concrete_ipv4  # noqa: PLC0415
