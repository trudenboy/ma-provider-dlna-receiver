...
**Cause:** DLNA Receiver OAuth tokens have a limited lifetime. After expiry, the provider loses API access.
...
**Cause:** The DLNA Receiver API closes long-lived connections. This is upstream service behaviour.
...
**Symptoms:** Some playlists or tracks are unavailable even though they open fine in the DLNA Receiver app.

**Cause:** Certain content is restricted by geography or subscription tier.

**Fix:** Content blocked by geo-restrictions or subscription limits cannot be played through the provider. This is a DLNA Receiver-side limitation.

---

## Multiple Accounts Not Yet Supported

**Symptoms:** Adding a second DLNA Receiver account causes the first to stop working.

**Cause:** The provider currently supports only one DLNA Receiver account.
