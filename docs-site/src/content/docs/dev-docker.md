...
# DLNA Receiver — Local Development with Docker

Run a full Music Assistant instance with DLNA Receiver provider pre-loaded locally —
...
## Adding the DLNA Receiver Provider

After login:

1. Go to **Settings** → **Providers**
2. Find **DLNA Receiver** in the list — it's already available, the code is pre-loaded
