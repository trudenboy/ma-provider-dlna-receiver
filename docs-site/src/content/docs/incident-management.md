...
# DLNA Receiver — Incident Management

## Where to Report Incidents

> **File issues here:** [github.com/trudenboy/ma-provider-dlna-receiver/issues](https://github.com/trudenboy/ma-provider-dlna-receiver/issues)
...
- **Provider field**: Set automatically for DLNA Receiver
